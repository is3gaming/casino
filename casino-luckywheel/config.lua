...
Config.Prices = {
	...
	[4]  = {type = 'item', 		name = 'casino_goldchip', 		count = 250, 	sound = 'chips', 	probability = {a =  10, b =  20}},	--  1.0 %   2.0 -- 250 chips
	...
	[7]  = {type = 'item', 		name = 'twerks_candy', 			count = 1, 		sound = 'clothes', 	probability = {a =  60, b =  80}},	--  4.0 %   8.0 -- CLOTHING
	[8]  = {type = 'item', 		name = 'casino_vip',  			count = 1, 		sound = 'mystery', 	probability = {a =  80, b = 120}},	--  4.0 %  12.0 -- MYSTERY
	[9]  = {type = 'item', 		name = 'casino_goldchip', 		count = 200, 	sound = 'chips', 	probability = {a = 120, b = 170}},	--  5.0 %  17.0 -- 200 chips
	[10] = {type = 'money', 	name = 'money', 				count = 7500, 	sound = 'cash', 	probability = {a = 170, b = 250}},	--  5.0 %  22.0 -- 7.500 RP
	[11] = {type = 'item',		name = 'twerks_candy', 			count = 1, 		sound = 'clothes', 	probability = {a = 250, b = 300}},	--  6.0 %  28.0 -- CLOTHING
	[12] = {type = 'item', 		name = 'casino_goldchip', 		count = 150, 	sound = 'chips', 	probability = {a = 300, b = 340}},	--  6.0 %  34.0 -- 1500 chips
	...
	[16] = {type = 'item',		name = 'casino_goldchip', 		count = 100, 	sound = 'chips', 	probability = {a = 610, b = 640}},	--  8.0 %  64.0 -- 100 chips
	...
	[19] = {type = 'item', 		name = 'twerks_candy', 			count = 1, 		sound = 'clothes', 	probability = {a = 810, b = 990}},	--  9.0 %  90.0 -- CLOTHING
